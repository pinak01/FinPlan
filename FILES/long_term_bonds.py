...
def scrape_ultra_short_funds():
    with sync_playwright() as p:
        ...
        page.goto("https://goldenpi.com/collections/bonds-for-long-term-investment")

        # Wait for the content to load
        page.wait_for_selector('.regular-text')  # Assuming the fund name has this class, adjust as needed

        # Scrape the data
        fund_names = page.query_selector_all('.inst-name')  # Adjust the selector based on the fund name's CSS class
        details = page.query_selector_all('.regular-text')
